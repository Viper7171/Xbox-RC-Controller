 ...
 * Use Right Stick for Throttle and Reverse
 * Use LB Low Gear
 * Use RB High Gear
 * 
...
void loop() {
  ...
  if (Xbox.XboxOneConnected) {
    if (Xbox.getAnalogHat(LeftHatX) > 200 || Xbox.getAnalogHat(LeftHatX) < -200 || Xbox.getAnalogHat(LeftHatY) > 7500 || Xbox.getAnalogHat(LeftHatY) < -7500 || Xbox.getAnalogHat(RightHatX) > 7500 || Xbox.getAnalogHat(RightHatX) < -7500 || Xbox.getAnalogHat(RightHatY) > 200 || Xbox.getAnalogHat(RightHatY) < -200) {
      ...
      //        Serial.print("\t");
      //      }
            if (Xbox.getAnalogHat(RightHatY) > 200 || Xbox.getAnalogHat(RightHatY) < -200) {
              ppm[1] = map(Xbox.getAnalogHat(RightHatY), -32768 , 32768, 1000, 2000) + throttleTrimActual;
            } else {
